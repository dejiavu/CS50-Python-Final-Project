# calculators.qt_friderica.py

"""
Equation to calculate corrected QT (QTc) interval based on Friderica formula
...
def calc_user_input(heart_rate, qt_interval):
    ...
    result = qt_interval / rr_interval ** (1/3)
    return round(result)
...
def print_result(heart_rate, qt_interval, result):
    ...
    print(color_text(f"*** QTc = {result} msec based on Friderica formula ***\n", BLUE))
