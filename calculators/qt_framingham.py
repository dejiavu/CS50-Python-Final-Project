# calculators.qt_framingham.py

"""
Equation to calculate corrected QT (QTc) interval based on Framingham formula
...
def calc_user_input(heart_rate, qt_interval):
    ...
    result = qt_interval + 154 * (1 - rr_interval)
    return round(result)
...
def print_result(heart_rate, qt_interval, result):
    ...
    print(color_text(f"*** QTc = {result} msec based on Framingham Formula ***\n", BLUE))
