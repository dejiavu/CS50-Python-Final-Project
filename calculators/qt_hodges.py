# calculators.qt_hodges.py

"""
Equation to calculate corrected QT (QTc) interval based on Hodges formula
...
def calc_user_input(heart_rate, qt_interval):
    ...
    result = qt_interval + 1.75 * ((60 / rr_interval) - 60)
    return round(result)
...
def print_result(heart_rate, qt_interval, result):
    ...
    print(color_text(f"*** QTc = {result} msec based on Hodges Formula ***\n", BLUE))
